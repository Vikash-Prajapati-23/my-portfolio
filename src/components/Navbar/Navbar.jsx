...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 z-1100 flex justify-between text-2xl lg:px-30 md:px-25 px-8 text-white bg-transparent lg:py-4 py-3 lg:gap-90 md:gap-56 font-semibold w-full ">
